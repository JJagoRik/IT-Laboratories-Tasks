...
public class Tasks5 {
    public static int[] encrypt(String str){                                                                            // 1 задание
    ...
    public static boolean camMove(String figure, String start, String end){                                             // 2 задание
            ...
            switch (figure.toLowerCase()) {
                ...
                case "knight":
                    if ((Math.abs(indexEndLine - indexStartLine) == 2 && Math.abs(indexEndRow - indexStartRow) == 1)
                            || (Math.abs(indexEndLine - indexStartLine) == 1 &&
                            Math.abs(indexEndRow - indexStartRow) == 2)){
                        return true;
                    }
                case "pawn":
                    if (((indexStartLine == 1 || indexStartLine == 6) && Math.abs(indexEndLine - indexStartLine) <= 2
                            && Math.abs(indexEndRow - indexStartRow) == 0)
                            || (Math.abs(indexEndLine - indexStartLine) <= 1 &&
                            Math.abs(indexEndRow - indexStartRow) == 0)){
                        return true;
    ...
    public static boolean canComplete(String startStr, String finalStr){                                                // 3 задание
    ...
    public static int sumDigProd(int ... nums) {                                                                        // 4 Задание
        int pr = 999;
        int sum = 0;
    ...
    public static ArrayList<String> sameVowelGroup(String[] words) {                                                    // 5 Задание
    ...
    public static boolean validateCard(long number){                                                                    // 6 задание
    ...
    public static String numToEng(int num){                                                                             // 7 задание
        StringBuilder string = new StringBuilder();
    ...
    /*public static String getSha256Hash(String stringToHash) throws NoSuchAlgorithmException {                           // 8 задание
    ...
    */
    public static String correctTitle(String title){                                                                    // 9 задание
    ...
    public static String hexLattice(int n){                                                                             // 10 задание
        if (n == 1){
            return " o ";
        }
        else{
