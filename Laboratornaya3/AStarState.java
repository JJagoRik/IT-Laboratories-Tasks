...
public class AStarState {
    ...
    {
        return openWaypoint.values().stream().min(Comparator.comparing(Waypoint::getTotalCost)).get();
    }
    ...
    public boolean addOpenWaypoint(Waypoint newWP)
    {
        if (openWaypoint.containsKey(newWP.getLocation())){
            if (openWaypoint.get(newWP.getLocation()).getPreviousCost() > newWP.getPreviousCost()){
